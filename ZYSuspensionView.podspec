#
#  Be sure to run `pod spec lint ZYSuspensionView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "ripper"
  # s.authors            = { "ripper" => "ripperhe@qq.com" }
  # s.social_media_url   = "http://twitter.com/ripper"
